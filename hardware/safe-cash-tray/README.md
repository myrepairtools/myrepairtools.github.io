...
| Footprint | **217.6 × 165.0 mm** |
| Height | 20 mm front lip rising to 45 mm at the back |
| Slots | 6 × 24 mm (notes) + 2 × 28 mm (coin rolls) |
| Labels | `$1 $5 $10 $20 $50 $100 COIN COIN`, engraved 0.6 mm |
| Material | ~220 cm³, so roughly 250–270 g |

## Check the safe first

**Floor needed: 218 × 165 mm. Height needed: 64 mm.**
...
**6 note slots + 2 wider coin-roll slots**, not 8 identical ones. US notes all
share one size, so six slots covers every denomination; the two 28 mm slots take
quarter rolls (25 mm across), and a 160 mm slot holds two rolls end to end.
...
tenth of a millimetre across the 218 mm span.

## Printing

Prints as exported: **flat on the floor, walls up. No supports, no brim** — the
first layer is a solid 218 × 165 mm rectangle, so adhesion is not going to be
the problem.
...
**It's a long print.** ~220 cm³ is most of a day on the P2S — slice it and look
at the real number before you commit. The acrylic one is $20 and arrives in two
days, so the case for printing rests entirely on the two things it can't do:
fitting *your* safe exactly, and carrying the denomination labels.
...
Slot count, widths and labels are all lists at the top of the file.
