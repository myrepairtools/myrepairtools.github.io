...
(function (root) {
  ...
  function styles(){
    ...
    s.textContent = ''
      ...
      + '#cpr-kiosk .kx-exit{border:1px solid rgba(255,255,255,.18);background:rgba(255,255,255,.06);color:rgba(255,255,255,.75);font-family:Nunito,sans-serif;font-weight:800;font-size:.72rem;padding:7px 13px;border-radius:999px;cursor:pointer;}'
      ...
      + '#cpr-kiosk .kx-key{height:72px;border:none;border-radius:16px;background:rgba(255,255,255,.09);color:#fff;font-family:Nunito,sans-serif;font-weight:800;font-size:1.7rem;cursor:pointer;transition:.1s;}'
      + '#cpr-kiosk .kx-key:active{background:rgba(255,255,255,.22);transform:scale(.97);}'
      + '#cpr-kiosk .kx-key.act{background:var(--kxc,#DC282E);}'
      + '#cpr-kiosk .kx-err{color:#ff9a9a;font-family:Nunito,sans-serif;font-weight:800;font-size:.86rem;min-height:20px;margin-top:14px;}'
      + '#cpr-kiosk .kx-big{width:100%;height:74px;border:none;border-radius:16px;font-family:Nunito,sans-serif;font-weight:900;font-size:1.2rem;cursor:pointer;color:#fff;margin-top:10px;}'
      ...
      + '#cpr-kiosk .kx-store{border:1.5px solid rgba(255,255,255,.2);background:rgba(255,255,255,.05);color:#fff;font-family:Nunito,sans-serif;font-weight:800;font-size:.9rem;padding:11px 16px;border-radius:12px;cursor:pointer;display:inline-flex;align-items:center;gap:8px;}'
