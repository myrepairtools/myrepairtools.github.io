...
(function (root) {
  ...
  function styles(){
    ...
    s.textContent = ''
      + '#cpr-kiosk{position:fixed;inset:0;z-index:2147483000;background:linear-gradient(160deg,#2D2D3B,#1c1c27);color:#fff;font-family:var(--font-sans);display:flex;flex-direction:column;align-items:center;justify-content:center;overflow:hidden;-webkit-user-select:none;user-select:none;touch-action:manipulation;}'
      ...
      + '#cpr-kiosk .kx-time{font-weight:700;font-size:1rem;color:rgba(255,255,255,.85);letter-spacing:.3px;}'
      + '#cpr-kiosk .kx-exit{border:1px solid rgba(255,255,255,.18);background:rgba(255,255,255,.06);color:rgba(255,255,255,.75);font-family:var(--font-sans);font-weight:600;font-size:.72rem;padding:7px 13px;border-radius:999px;cursor:pointer;}'
      + '#cpr-kiosk .kx-card{width:100%;max-width:360px;padding:20px;text-align:center;}'
      + '#cpr-kiosk .kx-h{font-weight:700;font-size:1.5rem;letter-spacing:-.4px;margin:0 0 4px;}'
      + '#cpr-kiosk .kx-sub{font-family:var(--font-sans);font-weight:500;font-size:.9rem;color:rgba(255,255,255,.6);margin-bottom:20px;}'
      ...
      + '#cpr-kiosk .kx-key{height:72px;border:none;border-radius:16px;background:rgba(255,255,255,.09);color:#fff;font-family:var(--font-sans);font-weight:600;font-size:1.7rem;cursor:pointer;transition:.1s;}'
      + '#cpr-kiosk .kx-key:active{background:rgba(255,255,255,.22);transform:scale(.97);}'
      + '#cpr-kiosk .kx-key.act{background:var(--kxc,#DC282E);}'
      + '#cpr-kiosk .kx-err{color:#ff9a9a;font-family:var(--font-sans);font-weight:600;font-size:.86rem;min-height:20px;margin-top:14px;}'
      + '#cpr-kiosk .kx-big{width:100%;height:74px;border:none;border-radius:16px;font-family:var(--font-sans);font-weight:700;font-size:1.2rem;cursor:pointer;color:#fff;margin-top:10px;}'
      ...
      + '#cpr-kiosk .kx-store{border:1.5px solid rgba(255,255,255,.2);background:rgba(255,255,255,.05);color:#fff;font-family:var(--font-sans);font-weight:600;font-size:.9rem;padding:11px 16px;border-radius:12px;cursor:pointer;display:inline-flex;align-items:center;gap:8px;}'
