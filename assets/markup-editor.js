...
(function(){
  ...
  var CSS='.edtools{display:flex;align-items:center;gap:4px;flex-wrap:wrap;border-top:1px solid var(--row,#F0F1F4);border-bottom:1px solid var(--row,#F0F1F4);padding:8px 28px;margin-top:16px;background:#fff}'
    +'.edtools button{font-family:\'Nunito\',sans-serif;font-weight:800;font-size:.74rem;border:1px solid transparent;border-radius:7px;background:none;color:var(--dark-grey);padding:5px 9px;cursor:pointer;white-space:nowrap}'
    +'.edtools button:hover{background:var(--light-grey);border-color:var(--border)}'
    +'.ed-rich{min-height:420px;padding:20px 28px 40px;font-family:\'Nunito Sans\',sans-serif;font-size:.95rem;line-height:1.75;color:#3A3A45;outline:none}'
    +'.ed-rich:focus{outline:none}'
    +'.ed-rich h3{font-family:\'Nunito\',sans-serif;font-weight:900;font-size:1.05rem;color:var(--dark);margin:22px 0 10px}'
    +'.ed-rich h4{font-family:\'Nunito\',sans-serif;font-weight:900;font-size:.95rem;color:var(--dark);margin:18px 0 8px}'
    ...
    +'.ed-rich a{color:#1E7AA8;font-weight:700}'
    ...
    +'.ed-rich .ed-callout{background:#FDF6E7;border:1.5px solid #F2DFAE;border-radius:10px;padding:13px 16px;margin:0 0 16px;font-size:.85rem;font-weight:700;color:#7A5A08;line-height:1.55}'
    ...
    +'.edtools select{font-family:\'Nunito\',sans-serif;font-weight:800;font-size:.74rem;border:1px solid var(--border);border-radius:7px;background:#fff;color:var(--dark-grey);padding:5px 7px;cursor:pointer}'
    ...
    +'.edmenu button{display:flex;align-items:center;justify-content:flex-start;gap:10px;width:100%;font-family:\'Nunito\',sans-serif;font-weight:800;font-size:.78rem;'
    ...
    +'.edmenu.cust .curow{display:flex;align-items:center;gap:9px;font-family:\'Nunito\',sans-serif;font-weight:800;font-size:.76rem;color:var(--dark-grey)}'
    ...
    +'.edmenu.cust .cupv{border:1.5px solid;border-radius:10px;padding:10px 12px;font-family:\'Nunito\',sans-serif;font-weight:800;font-size:.82rem}'
    ...
    +'.edmenu.pal button.none::after{content:\'\';position:absolute;inset:0;'
    +'.ed-rich table{border-collapse:collapse;width:100%;margin:12px 0;font-size:.86rem}'
    +'.ed-rich th,.ed-rich td{border:1px solid var(--border);padding:7px 10px;text-align:left;vertical-align:top;min-width:44px}'
    +'.ed-rich th{background:#F3F6FA;font-family:\'Nunito\',sans-serif;font-weight:800;color:var(--dark)}'
  ...
  const LIST_RE=window.CPRMarkup.LIST_RE, TABLE_RE=window.CPRMarkup.TABLE_RE,
        TSEP_RE=window.CPRMarkup.TSEP_RE, listBlock=window.CPRMarkup.listBlock, cells=window.CPRMarkup.cells;
