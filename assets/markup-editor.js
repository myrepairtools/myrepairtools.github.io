...
(function(){
  ...
  var CSS='.edtools{display:flex;align-items:center;gap:4px;flex-wrap:wrap;border-top:1px solid var(--row,#F0F1F4);border-bottom:1px solid var(--row,#F0F1F4);padding:8px 28px;margin-top:16px; background:#fff}'
    ...
    + '.edmenu button{display:flex;align-items:center;justify-content:flex-start;gap:10px;width:100%;font-family:\'Nunito\',sans-serif;font-weight:800;font-size:.78rem; border:none;background:none;color:var(--dark);padding:7px 10px;border-radius:7px;cursor:pointer;text-align:left;line-height:1.2}'
