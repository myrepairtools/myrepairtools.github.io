...
(function () {
  ...
  var CSS = ''
    ...
    + '.callout .ct{font-size:.85rem;font-weight:500;color:#7A5A08;line-height:1.55;min-width:0}'
    ...
    + '.callout .ct h3,.callout .ct h4,.callout .ct h5,.callout .ct h6{margin:0;color:inherit;font-family:var(--font-sans);font-weight:700}'
    ...
    + '.mk-tbl th{background:#F3F6FA;font-family:var(--font-sans);font-weight:600;color:#2D2D3B;white-space:nowrap}'
