/* Vendored SheetJS xlsx.mini.min.js v0.18.5 (Apache-2.0) — https://sheetjs.com
   Read-only .xlsx/.xls/.csv parsing for inventory-editor.html. Global: window.XLSX.
   Update: npm pack xlsx@<ver> && cp package/dist/xlsx.mini.min.js assets/xlsx.min.js */
